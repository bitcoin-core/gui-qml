...
Page {
        ...
        Column {
            ...
            Column {
                ...
                KeyValueRow {
                    ...
                    value: Loader {
                        sourceComponent: permissionsRow.isPermissioned ? permissioned : not_permissioned
                    }
                    Component {
                        id: permissioned
                ...
                KeyValueRow {
                    ...
                    value: Row {
                        IconButton {
                            iconLocation: transaction_relay_row.isTransactionRelay ? "image://images/check" : "image://images/cross"
                            anchors.verticalCenter: parent.verticalCenter
                        }
                    }
                }
                KeyValueRow {
                    id: address_relay_row
                    property bool isAddressRelay: details.addressRelay
                    key: KeyText { text: qsTr("Address relay"); }
                    value: Row {
                        IconButton {
                            iconLocation: address_relay_row.isAddressRelay ? "image://images/check" : "image://images/cross"
                            anchors.verticalCenter: parent.verticalCenter
                        }
                    }
                }
                KeyValueRow {
                    ...
                    key: KeyText {
                        text: qsTr("Mapped AS");
                        active: as_row.isMappedAS
                    }

                    value: Loader {
                        sourceComponent: as_row.isMappedAS ? mapped_as : not_mapped_as
                    }

                    Component {
                        id: mapped_as
                        ValText { text: as_row.mappedASValue; }
                    }
            ...
            Column {
                ...
                KeyValueRow {
                    ...
                    key: KeyText {
                        text: qsTr("Ping wait");
                        active: ping_wait_row.isPingWait
                    }

                    value: Loader {
                        sourceComponent: ping_wait_row.isPingWait ? ping_wait : not_ping_wait
                    }

                    Component {
                        id: ping_wait
                        ValText { text: ping_wait_row.pingWaitValue; }
                    }
    ...
    component IconButton: Button {
        id: icon_button
        property alias iconLocation: icon_button.icon.source
        padding: 0
        display: AbstractButton.IconOnly
        height: 21
        width: 21
    ...
    component NetStatValue: Row {
        property alias text: val_text.text
        spacing: 0
        NetStatIndicator {}
        ValText {
            id: val_text
