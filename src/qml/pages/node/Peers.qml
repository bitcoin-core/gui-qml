        ...
        footer: Item {
            ...
            ColumnLayout {
                ...
                Loader {
                    Layout.fillWidth: true
                    height: 75
                    active: nodeNetworkModel.numOutboundPeers < nodeNetworkModel.maxNumOutboundPeers
                    visible: active
                    sourceComponent: Item {
                        ...
                        RowLayout {
                            ...
                            PeersIndicator {
                                paused: false
                                numOutboundPeers: nodeNetworkModel.numOutboundPeers
                                maxNumOutboundPeers: nodeNetworkModel.maxNumOutboundPeers
                            }
                            CoreText {
                                text: qsTr("Looking for %1 more peer(s)").arg(
                                        nodeNetworkModel.maxNumOutboundPeers - nodeNetworkModel.numOutboundPeers)
                                font.pixelSize: 15
                                color: Theme.color.neutral7
                            }
                        }
