...
{
    Q_OBJECT
    Q_PROPERTY(qint64 nodeId READ nodeId NOTIFY dataChanged)
    Q_PROPERTY(bool connected READ connected NOTIFY disconnected)
...
public:
    ...
    qint64 nodeId() const { return m_node_id; }
    bool connected() const { return !m_disconnected; }
