...
//
//     QT_QPA_PLATFORM=xcb     build/bin/test_bitcoin-qt-legacy  # Linux
//     QT_QPA_PLATFORM=windows build/bin/test_bitcoin-qt-legacy  # Windows
//     QT_QPA_PLATFORM=cocoa   build/bin/test_bitcoin-qt-legacy  # macOS
