...
TestCase {
    ...
    function test_rpcConsoleUsesSettingsContainerAndTracksVisibility() {
        ...
        compare(nextSearchFocusBorder.visible, false)
        keyClick(Qt.Key_Tab)
        ...
        compare(previousSearchFocusBorder.visible, false)
        keyClick(Qt.Key_Tab)
        ...
        compare(increaseFocusBorder.visible, false)
        keyClick(Qt.Key_Tab)
        ...
        compare(decreaseFocusBorder.visible, false)
